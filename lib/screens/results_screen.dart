...
class _ResultsScreenState extends State<ResultsScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // التقويم الأسبوعي المطور لتغطية حصاد اللقاءات السابقة والمنتهية
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // 📅 أولاً: شريط التقويم الأسبوعي المتكامل (7 مربعات كاملة أفقية لتقويم الأيام مع التوهج والاهتزاز اللمسي)
                    SizedBox(
                      height: 80,
                    ...
                    // 🛸 ثانياً: مستطيل الإعلانات الخرافي المتموج والمتحرك سحابياً بالكامل يستقر مباشرة تحت الأيام بالصيغة الإحصائية لنتائج اليوم
                    Padding(
                          ...
                          child: AnimatedBuilder(
                            ...
                            builder: (context, child) {
                              return FractionalTranslation(
                                ...
                                child: Center(
                                  child: Text(
                                    '⚽ NF SPORTS RESULTS 📊', // صياغة البراند الحركية الخاصة بحصاد الأهداف والنتائج
                                    maxLines: 1,
                    ...
                    FutureBuilder<List<Map<String, dynamic>>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        // 🔍 تصفية هندسية صافية وحصرية للقاءات المنتهية فقط المجلوبة حياً من جدول السحاب الموحد
                        ...
                        matches = matches.where((m) {
                          ...
                          return m.isEnded; // جلب حصرى للمباريات المكتملة لصبها داخل جدول النتائج الصافي
                        }).toList();

                        matches.sort((a, b) => b.matchDate.compareTo(a.matchDate));

                        // ⚽ لوحة الاستاد الهادئ البديلة والمطهرة بالكامل باللون النيوني المعتم عند خلو نتائج هذا اليوم
                        if (matches.isEmpty) {
                          return Padding(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                buildCustomResultCard(context, match), // الاستدعاء الحصري والمباشر لكرت حصاد النتائج المنتهية
                              ],
                            );
                          },
                        );
  ...
  // 👑 كرت النتائج المكتملة والمضغوط هندسياً لتوحيد أبعاد وهوية أقسام الشاشة والجدول
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  // الفريق الأول باللوغو الصافي والواضح
                  Expanded(
                    child: Row(
                      textDirection: TextDirection.rtl,
                      children: [
                  ...
                  // العمود المركزي: النتيجة النهائية للألعاب المنتهية القادمة من السيرفر الموحد
                  Column(
                    children: [
                  ...
                  // الفريق الثاني باللوغو الصافي والواضح
                  Expanded(
                    child: Row(
                      children: [
                        Container(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  // شارات الجودة وحالة اللقاء المنتهية FT مع كبسولة التوقيع وحماية حقوق الملكية NF بالملي
                  Row(
                    children: [
                      Container(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: const Color(0xFF00FF66).withOpacity(0.4), width: 0.8),
                        ),
                        child: Text("FT", style: GoogleFonts.cairo(color: const Color(0xFF00FF66), fontSize: 7, fontWeight: FontWeight.w900)),
                      ),
                    ],
                  ),
                  
                  // زر زجاجي نيونى ناعم للانتقال الفوري لشاشة تفاصيل اللقاء الإحصائية المتقدمة
                  InkWell(
                    onTap: () {
