            ...
            child: Column(
              ...
              children: [
                ...
                const Padding(
                  padding: EdgeInsets.symmetric(horizontal: 24, vertical: 4),
                  child: Text(
                    'التشكيلة التكتيكية الرسمية للخطوط',
                    style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.bold, fontFamily: 'Cairo'),
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        'مرر الشاشة أفقياً لرؤية تشكيلة الخصم المتقابلة',
                        style: GoogleFonts.cairo(
                          color: Colors.white38,
                          fontSize: 10,
                          fontWeight: FontWeight.bold,
                ...
                const Padding(
                  padding: EdgeInsets.symmetric(horizontal: 24, vertical: 4),
                  child: Text(
                    'شريط الأحداث الزمني والتبديلات',
                    style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.bold, fontFamily: 'Cairo'),
                  ),
                ),
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              Text(
                                'توقع الفائز في هذه الملحمة الكروية',
                                style: GoogleFonts.cairo(
                                  color: Colors.white,
                                  fontSize: 12,
                                  fontWeight: FontWeight.bold,
                          ...
                          ClipRRect(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  Expanded(
                                    flex: _homeVotes > 0 ? _homeVotes : 1,
                                    child: Container(
                                      color: const Color(0xFF00A3FF),
                                      child: Center(
                                        child: Text(
                                          '${(_homeVotes + _drawVotes + _awayVotes) > 0 ? ((_homeVotes / (_homeVotes + _drawVotes + _awayVotes)) * 100).toStringAsFixed(0) : 0}%',
                                          style: const TextStyle(
                                            color: Colors.white,
                                            fontSize: 10,
                                            fontWeight: FontWeight.bold,
                                  ...
                                  Expanded(
                                    flex: _drawVotes > 0 ? _drawVotes : 1,
                                    child: Container(
                                      color: Colors.white.withOpacity(0.05),
                                      child: Center(
                                        child: Text(
                                          '${(_homeVotes + _drawVotes + _awayVotes) > 0 ? ((_drawVotes / (_homeVotes + _drawVotes + _awayVotes)) * 100).toStringAsFixed(0) : 0}%',
                                          style: const TextStyle(
                                  ...
                                  Expanded(
                                    flex: _awayVotes > 0 ? _awayVotes : 1,
                                    child: Container(
                                      color: const Color(0xFF00A3FF).withOpacity(0.4),
                                      child: Center(
                                        child: Text(
                                          '${(_homeVotes + _drawVotes + _awayVotes) > 0 ? ((_awayVotes / (_homeVotes + _drawVotes + _awayVotes)) * 100).toStringAsFixed(0) : 0}%',
                                          style: const TextStyle(
                                            color: Colors.white70,
                                            fontSize: 10,
                                            fontWeight: FontWeight.bold,
                          ...
                          if (!_hasVoted) ...[
                            ...
                            const SizedBox(height: 8),
                            Text(
                              'شكراً لتصويتك! أنت توقعت: ${_myVoteChoice == 'home' ? widget.team1 : (_myVoteChoice == 'away' ? widget.team2 : 'التعادل')}',
                              style: GoogleFonts.cairo(
                                color: const Color(0xFF00A3FF),
                                fontSize: 10,
                                fontWeight: FontWeight.bold,
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (commentsData.isEmpty) {
                      return Padding(
                        ...
                        child: Center(
                          child: Text(
                            'كن أول من يطلق العنان لصوته في هذه الملحمة!',
                            style: GoogleFonts.cairo(
                              color: Colors.white38,
                              fontSize: 11,
                              fontWeight: FontWeight.bold,
                                  ...
                                  if (audioUrl != null && audioUrl.isNotEmpty) ...[
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        textDirection: TextDirection.rtl,
                                        children: [
                                          const Icon(Icons.audiotrack, color: Color(0xFF00A3FF), size: 16),
                                          const SizedBox(width: 8),
                                          Text(
                                            'رسالة صوتية 🎙️',
                                            style: GoogleFonts.cairo(
                                          ...
                                          const Spacer(),
                                          IconButton(
                                            icon: const Icon(Icons.play_arrow_rounded, color: Color(0xFF00A3FF), size: 16),
                                            onPressed: () {},
                                          ),
                                        ],
                                      ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          InkWell(
                                            onTap: () => _likeComment(id, likes),
                                            child: Row(
                                              children: [
                                                const Icon(Icons.thumb_up_rounded, color: Color(0xFF00A3FF), size: 12),
                                          ...
                                          InkWell(
                                            ...
                                            child: Row(
                                              children: [
                                                const Icon(Icons.reply_rounded, color: Colors.white24, size: 12),
                                                const SizedBox(width: 4),
                                                Text(
                                                  'رد',
                                                  style: GoogleFonts.cairo(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: _replyingToCommentId != null
                                ? 'اكتب ردك...'
                                : 'اكتب نقاشك الرياضي الفخم هنا...',
                            hintStyle: GoogleFonts.cairo(color: Colors.white24, fontSize: 11),
                            hintTextDirection: TextDirection.rtl,
                            filled: true,
                            fillColor: const Color(0xFF161926).withOpacity(0.5),
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: _isRecording
                                    ...
                                    : const Icon(Icons.mic_rounded, color: Colors.white60, size: 18),
                              ),
                            ),
                          );
                        },
                      ...
                      Container(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            ...
                            if (txt.isNotEmpty) _submitComment(txt);
                            _chatController.clear();
                            _replyingToCommentId = null;
                          },
                        ),
